...
* [Radare2](https://github.com/radare/radare2) ⭐ 24,792 | 🐛 822 | 🌐 C | 📅 2026-09-13 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
...
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,658 | 🐛 13 | 🌐 Shell | 📅 2026-09-11 - Analyze Linux-based firmware of embedded devices.
* [Firmadyne](https://github.com/firmadyne/firmadyne) ⭐ 2,103 | 🐛 107 | 🌐 Shell | 📅 2024-07-21 - Tries to emulate and pentest a firmware.
