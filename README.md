...
* [HAL – The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 820 | 🐛 19 | 🌐 C++ | 📅 2026-08-21 - A comprehensive reverse engineering and manipulation framework for gate-level netlists.
...
* [Radare2](https://github.com/radare/radare2) ⭐ 24,620 | 🐛 821 | 🌐 C | 📅 2026-08-22 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
...
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,601 | 🐛 28 | 🌐 Shell | 📅 2026-08-22 - Analyze Linux-based firmware of embedded devices.
* [Firmadyne](https://github.com/firmadyne/firmadyne) ⭐ 2,099 | 🐛 107 | 🌐 Shell | 📅 2024-07-21 - Tries to emulate and pentest a firmware.
