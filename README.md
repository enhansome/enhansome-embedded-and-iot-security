...
* [HAL – The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 820 | 🐛 19 | 🌐 C++ | 📅 2026-08-18 - A comprehensive reverse engineering and manipulation framework for gate-level netlists.
...
* [Radare2](https://github.com/radare/radare2) ⭐ 24,592 | 🐛 823 | 🌐 C | 📅 2026-08-18 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,235 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Searches a binary for "interesting" stuff, as well as extracts arbitrary files.
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,596 | 🐛 30 | 🌐 Shell | 📅 2026-08-17 - Analyze Linux-based firmware of embedded devices.
* [Firmadyne](https://github.com/firmadyne/firmadyne) ⭐ 2,098 | 🐛 107 | 🌐 Shell | 📅 2024-07-21 - Tries to emulate and pentest a firmware.
...
* [flashrom](https://github.com/flashrom/flashrom) ⭐ 1,165 | 🐛 79 | 🌐 C | 📅 2026-08-17 - Tool for detecting, reading, writing, verifying and erasing flash chips.
...
* [Glasgow](https://github.com/GlasgowEmbedded/Glasgow) ⭐ 2,195 | 🐛 80 | 🌐 Python | 📅 2026-08-18 - Tool for exploring and debugging different digital interfaces.
...
* 2019, Yago Hansen: [The Hacker's Hardware Toolkit: The best collection of hardware gadgets for Red Team hackers, Pentesters and security researchers](https://github.com/yadox666/The-Hackers-Hardware-Toolkit/blob/master/TheHackersHardwareToolkit.pdf) ⭐ 2,174 | 🐛 5 | 📅 2020-09-07
...
* [IoTGoat](https://github.com/scriptingxss/IoTGoat) ⭐ 182 | 🐛 1 | 🌐 C | 📅 2020-03-29 - IoTGoat is a deliberately insecure firmware based on OpenWrt.
