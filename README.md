...
* [Routersploit](https://github.com/threat9/routersploit) ⭐ 13,242 | 🐛 97 | 🌐 Python | 📅 2026-05-05 - Framework dedicated to exploit embedded devices.
* [PRET](https://github.com/RUB-NDS/PRET) ⭐ 4,309 | 🐛 73 | 🌐 Python | 📅 2024-08-02 - Printer Exploitation Toolkit.
...
* [HAL – The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 829 | 🐛 18 | 🌐 C++ | 📅 2026-09-13 - A comprehensive reverse engineering and manipulation framework for gate-level netlists.
...
* [Radare2](https://github.com/radare/radare2) ⭐ 24,822 | 🐛 824 | 🌐 C | 📅 2026-09-18 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,348 | 🐛 94 | 🌐 Rust | 📅 2026-08-11 - Searches a binary for "interesting" stuff, as well as extracts arbitrary files.
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,666 | 🐛 13 | 🌐 Shell | 📅 2026-09-18 - Analyze Linux-based firmware of embedded devices.
* [Firmadyne](https://github.com/firmadyne/firmadyne) ⭐ 2,106 | 🐛 107 | 🌐 Shell | 📅 2024-07-21 - Tries to emulate and pentest a firmware.
* [cwe\_checker](https://github.com/fkie-cad/cwe_checker) ⭐ 1,357 | 🐛 30 | 🌐 Rust | 📅 2026-08-20 - Finds vulnerable patterns in binary executables - ELF support for x86, ARM, and MIPS, experimental bare-metal support.
...
* [Firmware Mod Kit](https://github.com/rampageX/firmware-mod-kit/wiki) ⭐ 1,001 | 🐛 62 | 🌐 C | 📅 2026-02-17 - Extraction tools for several container formats.
...
* [Glasgow](https://github.com/GlasgowEmbedded/Glasgow) ⭐ 2,208 | 🐛 81 | 🌐 Python | 📅 2026-09-18 - Tool for exploring and debugging different digital interfaces.
...
* 2019, Yago Hansen: [The Hacker's Hardware Toolkit: The best collection of hardware gadgets for Red Team hackers, Pentesters and security researchers](https://github.com/yadox666/The-Hackers-Hardware-Toolkit/blob/master/TheHackersHardwareToolkit.pdf) ⭐ 2,177 | 🐛 5 | 📅 2020-09-07
...
* [IoTGoat](https://github.com/scriptingxss/IoTGoat) ⭐ 184 | 🐛 1 | 🌐 C | 📅 2020-03-29 - IoTGoat is a deliberately insecure firmware based on OpenWrt.
...
* [CSAW Embedded Security Challenge 2019](https://github.com/TrustworthyComputing/csaw_esc_2019) ⭐ 38 | 🐛 2 | 🌐 Python | 📅 2019-11-24 - CSAW 2019 Embedded Security Challenge (ESC).
