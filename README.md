...
* [Radare2](https://github.com/radare/radare2) ⭐ 24,778 | 🐛 824 | 🌐 C | 📅 2026-09-11 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
...
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,655 | 🐛 13 | 🌐 Shell | 📅 2026-09-11 - Analyze Linux-based firmware of embedded devices.
...
* [flashrom](https://github.com/flashrom/flashrom) ⭐ 1,169 | 🐛 80 | 🌐 C | 📅 2026-09-11 - Tool for detecting, reading, writing, verifying and erasing flash chips.
