...
* [Routersploit](https://github.com/threat9/routersploit) ⭐ 13,244 | 🐛 97 | 🌐 Python | 📅 2026-05-05 - Framework dedicated to exploit embedded devices.
...
* [HAL – The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 828 | 🐛 18 | 🌐 C++ | 📅 2026-09-13 - A comprehensive reverse engineering and manipulation framework for gate-level netlists.
...
* [Radare2](https://github.com/radare/radare2) ⭐ 24,836 | 🐛 826 | 🌐 C | 📅 2026-09-20 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,357 | 🐛 94 | 🌐 Rust | 📅 2026-08-11 - Searches a binary for "interesting" stuff, as well as extracts arbitrary files.
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,673 | 🐛 13 | 🌐 Shell | 📅 2026-09-18 - Analyze Linux-based firmware of embedded devices.
...
* [Glasgow](https://github.com/GlasgowEmbedded/Glasgow) ⭐ 2,208 | 🐛 83 | 🌐 Python | 📅 2026-09-19 - Tool for exploring and debugging different digital interfaces.
