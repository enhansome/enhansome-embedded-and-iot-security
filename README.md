...
* [Radare2](https://github.com/radare/radare2) ⭐ 24,800 | 🐛 826 | 🌐 C | 📅 2026-09-14 - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
...
* [emba](https://github.com/e-m-b-a/emba) ⭐ 3,663 | 🐛 14 | 🌐 Shell | 📅 2026-09-15 - Analyze Linux-based firmware of embedded devices.
